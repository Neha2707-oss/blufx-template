...
<head>
    ...
    <title>Blufx - Forex Trading</title>
    ...
    <link rel="stylesheet" href="assets/css/vendor/flaticon_blufx.css">
                                            ...
                                            <ul>
                                                ...
                                                <li class="has-dropdown has-mega-menu">
                                                    ...
                                                    <ul class="mega-menu mega-menu-grid-3">
                                                        <li>
                                                            <a href="javasript:void(0);" class="mega-menu-title">Quick Start</a>
                                                            <ul>
                                                                <li><a href="forex">What is Forex ?</a></li>
                                                                <li><a href="blufx">Why BluFx LLC ?</a></li>
                                                                <li><a href="what-trade">What You Can Trade</a></li>
                                                            </ul>
                                                        </li>
                                                        <li>
                                                            <a href="javasript:void(0);" class="mega-menu-title">Trading</a>
                                                            <ul>
                                                                <li><a href="acount">Account Types</a></li>
                                                                <li><a href="funding">Funding</a></li>
                                                                <li><a href="withdrawal">Withdrawals</a></li>
                                                                <li><a href="lps">Partner</a></li>
                                                                <li><a href="broker">Our Broker</a></li>
                                                            </ul>
                                                        </li>
                                                        <li>
